...
modules.init = function (gulp) {
  ...
  gulp.task('modules:svg', ['modules:pre'], function() {
  ...
  gulp.task('modules', ['modules:javascript', 'modules:style', 'modules:svg'], function () {
    ...
    modules.forEach(function (module) {
      ...
      var s = gulp.src(globs).pipe(gulp.dest(folders.dest + '/' + module.folder));
